...
-- CreateIndex
CREATE INDEX "TestCaseResults_submissionId_idx" ON "TestCaseResults"("submissionId");
...
-- AddForeignKey
ALTER TABLE "TestCaseResults" ADD CONSTRAINT "TestCaseResults_submissionId_fkey" FOREIGN KEY ("submissionId") REFERENCES "Submission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
